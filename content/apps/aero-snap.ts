...
// Aero Snap — region-picker app (FAA / EASA in one app, each with its own tabs).
// From content-briefs/aero-snap.md. Both datasets are bundled (~91 MB), no
...
export const aeroSnap: AppContent = {
  slug: "aero-snap",
  name: "Aero Snap",
  ...
  dataStats: {
    ...
    body: "Aero Snap bundles the full FAA corpus and the full EASA corpus on-device — ~91 MB combined, indexed for full-text search. Pick a home authority; switch anytime. No subscription, no download.",
    stats: [
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        "None. Aero Snap makes zero tracking or analytics requests. Your favorites, collections, notes, and compliance ticks stay on your device. The only outbound connections are ones you trigger — opening a source link, or activating a Supporter unlock.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "No. Aero Snap is an offline lookup and organization tool for trained aviation-maintenance professionals. Airworthiness determinations, method-of-compliance calls, and return-to-service decisions still require the controlled FAA / EASA documents and qualified judgment. Every entry links back to its source.",
    },
  ],
  ...
  seo: {
    title: "Aero Snap — FAA and EASA regs in one app",
    description:
